                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" name="merk" class="form-control add" placeholder="Masukkan Merk Barang" />
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control add" id="sell_price" name="sell_price" placeholder="Masukkan Harga Jual" aria-label="Harga Jual" aria-describedby="rp-addon" oninput="mustInRupiahCurrency(this)" value="{{ $defaultSellPrice }}">
...
@push('js')
    ...
    <script>
        ...
        $('#form-add').on('submit', function(e) {
            ...
            const data = {
                merk: $('input[name="merk"].add').val(),
                sell_price: validInt($('input[name="sell_price"].add').val()),
            };
            ...
            wize.ajax({
                ...
                data,
                method: "POST",
                inputSelector: 'input[name="{key}"].add',
                modalSelector: '#modal-add',
                addon_success: (data) => {
                    wizeTable.reload();
                    $('input[name="merk"].add').val('');
                },
            });
        })
