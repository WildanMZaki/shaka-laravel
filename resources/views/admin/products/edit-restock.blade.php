...
@section('title', 'Edit Data Restock')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('products.restocks.update') }}" id="update-restock-product" method="PUT">
                            <input type="hidden" name="id" id="restock_id" value="{{ $restock->id }}">
                            @csrf
                            @php
                            ...
                            <div class="row">                                
                                <div class="col-lg-6 col-xl-6">
                                    ...
                                    <select class="select-merk apply-select2 updateInput" name="merk_id" id="merk_id" data-placeholder="Pilih Merk Barang" data-allow-clear="1">
                                        @if (!isset($restock))
                                            <option value=""></option>
                                        @endif
                                ...
                                <div class="col-lg-3 col-xl-3 mt-3 mt-lg-0 mt-xl-0">
                                    ...
                                    <input type="date" name="transaction_date" id="transaction_date" class="form-control updateInput">
                                ...
                                <div class="col-lg-3 col-xl-3 mt-3 mt-lg-0 mt-xl-0">
                                    ...
                                    <input type="date" name="expiration_date" id="expiration_date" class="form-control updateInput">
                            ...
                            <div class="row mt-lg-3">
                                <div class="col-lg-4 col-xl-4 mt-3 mt-lg-0 mt-xl-0">
                                    ...
                                    <input type="number" value="{{ $restock->jumlah }}" name="qty" id="qty" class="form-control updateInput" min="1" placeholder="Masukkan Jumlah Barang" oninput="mustBeAtLeast(this, 1, countTotal)">
                                    <span class="invalid-feedback" id="qty-invalid-msg"></span>
                                </div>
                                <div class="col-lg-4 col-xl-4 mt-3 mt-lg-0 mt-xl-0">
                                    <label for="unit" class="form-label">Satuan <span class="text-danger">*</span></label>
                                    <select class="select-unit apply-select2 updateInput" name="unit" id="unit" data-hide-search="1">
                                ...
                                <div class="col-lg-4 col-xl-4 mt-3 mt-lg-0 mt-xl-0">
                                    ...
                                    <input type="text" value="{{ $restock->qty }} Botol" name="total_barang" id="total_barang" class="form-control disabled" disabled placeholder="0">
                                </div>
                            </div>
                            ...
                            <div class="row mt-lg-3">
                                <div class="col-lg-3 col-xl-3 mt-3 mt-lg-0 mt-xl-0">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{ $restock->formatted_modal }}" class="form-control updateInput" id="price_total" name="price_total" placeholder="Masukkan harga beli" aria-label="Harga Beli" aria-describedby="rp-addon" oninput="mustInRupiahCurrency(this, thousandsId, countSatuanPrice)">
                                        <span class="invalid-feedback" id="price_total-invalid-msg"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-xl-3 mt-3 mt-lg-0 mt-xl-0">
                                    <label class="form-label" for="price">Harga Satuan</label>
                                    <input type="text" name="price" id="price" class="form-control disabled" disabled placeholder="{{ $restock->formatted_price_item }}">
                                </div>       
                                <div class="col-lg-6 col-xl-6 mt-3 mt-lg-0 mt-xl-0">
                                    <label class="form-label" for="description">Keterangan <i>(Opsional)</i></label>
                                    <input type="text" value="{{ $restock->description }}" class="form-control updateInput" id="description" name="description" placeholder="Tambahkan keterangan (Opsional)">
...
@push('js')
    ...
    <script>
        ...
        $('#transaction_date').flatpickr({
            enableTime: false,
            dateFormat: "j M Y",
            defaultDate: new Date('{{ $restock->restock_date }}'),
        });
        ...
        $('#expiration_date').flatpickr({
            enableTime: false,
            dateFormat: "j M Y",
            defaultDate: new Date('{{ $restock->expiration_date }}').setMonth(new Date().getMonth() + 2),
        });
    </script>
    <script>
        const wize = new Wize();
